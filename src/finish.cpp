...
void Finish::end(int flag)
{
  ...
  if (timeflag && timer->has_normal()) {
    ...
    mpi_timings("DW_FWD",self_timer,Timer::DW_FWD,world,nprocs,nthreads,me,time_loop,screen,logfile);
    mpi_timings("DP_TIME",self_timer,Timer::DP_TIME,world,nprocs,nthreads,me,time_loop,screen,logfile);
